...
const TeacherClassCard = ({ classItem, setSelectedClass, setShowOverview }) => {
    ...
    return (
        <div
            ...
            className="cursor-pointer w-[259px] h-[323px] border-primary-3 border-solid border-2 rounded-[10px] overflow-hidden"
        >
            ...
            <div className="p-3 px-4 h-[173px] flex flex-col justify-between">
                <h2 className="text-[20px] font-bold text-text-1">{classItem.name}</h2>
                <div className="flex items-center justify-between">
                    <div className="mt-auto flex items-center gap-1">
                        ...
                        <p className="text-text-2 text-base">{classItem.class_limit}</p>
                    </div>
                    <p className="underline text-text-2">{classItem.class_code}</p>
                </div>
            </div>
        </div>
    );
