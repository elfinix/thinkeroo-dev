...
const TeacherClassCard = ({ classItem, setSelectedClass, setShowOverview }) => {
    ...
    return (
        <div
            ...
            className="cursor-pointer w-[259px] h-[323px] border-primary-3 border-solid border-2 rounded-[10px] overflow-hidden relative"
        >
            ...
            <div className="p-3 px-4 h-[173px] flex flex-col justify-between">
                <div className="flex justify-between items-center relative">
                    <h2 className="text-[20px] font-bold text-text-1 w-[80%]">{classItem.name}</h2>
                    ...
                    {showPopUp && <TeacherClassCardPopUp />}
                </div>
