...
const TeacherCreateClass = ({ setShowCreateClass }) => {
    return (
        <div className="absolute top-0 left-0 w-screen h-screen bg-[#00000080] flex items-center justify-center">
            <div className="p-6 bg-primary-1 border-2 border-primary-3 border-solid w-[745px] rounded-[10px]">
                ...
                <div className="flex gap-4 mt-[20px] w-full">
                    <button onClick={() => setShowCreateClass(false)} className="ml-auto w-[119px] h-[42px] border-solid border-2 border-text-1 rounded-[50px] text-text-1 font-medium text-base flex items-center justify-center">
                        Cancel
                    </button>
