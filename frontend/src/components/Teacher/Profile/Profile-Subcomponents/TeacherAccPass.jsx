...
// import TeacherModal from "../../teacher-basic-components/teacher-modal-components/TeacherModal";

function TeacherAccPass({ teacher }) {
    ...
    const validateForm = () => {
        ...
        } else if (formData.currentPassword !== teacher.institutionDetail.password) {
    ...
    const handleDeleteAccount = () => {
        ...
        setModalDescription(
            "Deleting your account will remove all your data permanently. Are you sure you want to proceed?"
        );
        setModalBttn("Delete");
        setIsModalOpen(true);
    };
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <button
                            type="button"
                            className="absolute right-2 top-2 text-text-2"
                            onClick={() => togglePasswordVisibility("current")}
                        >
                            {isCurrentPasswordVisible ? <EyeClosed size={20} /> : <Eye size={20} />}
                        </button>
                    </div>
                </div>
                {/* New Password */}
                <div>
                    ...
                    <div className="relative">
                        ...
                        >
                            {isNewPasswordVisible ? <EyeClosed size={20} /> : <Eye size={20} />}
                        </button>
                    </div>
                </div>
                {/* Confirm Password */}
                <div>
                    ...
                    <div className="relative">
                        ...
                        >
                            {isConfirmPasswordVisible ? <EyeClosed size={20} /> : <Eye size={20} />}
                        </button>
                    </div>
                    {errors.general && <div className="text-red-500 mt-4 font-light text-sm">{errors.general}</div>}
