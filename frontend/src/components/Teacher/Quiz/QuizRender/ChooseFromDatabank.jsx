...
const ChooseFromDatabank = ({ setShowBank }) => {
                ...
                return (
                    <div className="w-full h-full flex flex-col justify-between">
                        ...
                        <div className="flex gap-4 w-full justify-center mt-auto">
                            <button onClick={() => setShowBank(false)} className="w-[119px] h-[42px] rounded-full border-2 border-text-1 bg-transparent">Cancel</button>
                            <button className="w-[119px] h-[42px] rounded-full border-0 bg-accent-1 text-primary-1">Done</button>
                        </div>
                    </div>
                )
                ...
                return (
                    <div className="w-full h-full flex flex-col justify-between overflow-hidden">
                        ...
                        <div className="w-full h-full flex flex-col gap-6 overflow-y-auto">
                            <div className="w-full p-4 border-2 border-primary-3 rounded-[10px]">
