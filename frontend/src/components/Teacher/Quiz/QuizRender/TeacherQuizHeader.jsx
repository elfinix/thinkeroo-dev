...
const TeacherQuizHeader = ({ selectQuiz }) => {
    return (
        <div className="w-11/12 h-[76px] border-b-primary-3 border-2 border-x-0 border-t-0 flex items-center justify-between">
            <div className="border-primary-3 border-2 w-[298px] h-[42px] rounded-[10px] overflow-hidden flex px-2">
                ...
                <input placeholder="Search quiz" className="bg-transparent border-none w-full h-full p-2 text-text-1 focus:outline-none placeholder:text-text-2" type="text" name="" id="" />
            </div>
            <button onClick={() => selectQuiz(true)} className="w-[163px] h-[42px] flex items-center justify-center text-primary-1 font-medium text-[16px] bg-accent-1 rounded-[50px] gap-2">
...
export default TeacherQuizHeader