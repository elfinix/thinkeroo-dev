...
function StudentShowCorrect() {
  ...
  const checkAnswer = (question) => {
    if (question.type === 'select_multiple') {
      return question.studentAnswer.sort().toString() === question.correctAnswer.sort().toString();
    }
  ...
  return (
    <div className="flex flex-col min-h-screen bg-primary-1 text-text-1 font-lexend">
        ...
        <div className="sticky top-[68px] z-50 bg-primary-1 border-b-2 pb-2 border-b-primary-3 ml-40 mb-5"> {/*adjust margin here for side menu*/}
          ...
          {initialQuestionsData.map((question, idx) => {
            ...
            return (
              <div
                ...
                className={`border-2 p-6 rounded-xl ${isCorrect ? 'border-green-500' : 'border-red-500'}`}
              >
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  {question.type === 'short_answer' && (
                    <div
                      className={`flex-1 border-2 py-2 rounded-xl text-primary-3 border-primary-3 ${
                        isError ? 'border-2 border-primary-3 text-text-2 pl-2 ' : 'border-2 border-primary-3 text-text-2 pl-2'
                      }`}
                    >
...
export default StudentShowCorrect;
