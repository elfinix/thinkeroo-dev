...
import { API_ENDPOINT } from "/constants/constants"; // Ensure this path is correct
    ...
    const handleJoin = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                `${API_ENDPOINT}/api/user-class/join_class/`,
            ...
            onJoin(response.data); // Handle successful join, e.g., refresh class list
            onClose();
        } catch (err) {
                ...
                <div className="mb-4">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full p-2 text-sm sm:text-base border ${
                                error ? "border-red-600" : "border-primary-3"
                            } border-2 rounded-lg focus:outline-none bg-primary-1`}
                        />
