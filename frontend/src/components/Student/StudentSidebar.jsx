...
const StudentSidebar = ({ studentRender, setStudentRender }) => {
    ...
    return (
        <>
            <div
                className={`student_sidebar ${
                    expand ? "w-[270px]" : "w-[112px]"
                } bg-primary-1 h-full border-r-2 border-primary-3 border-solid p-6 flex flex-col items-center justify-start relative`}
            >
                <button
                ...
                <div className="flex flex-col items-center justify-center gap-6 mt-24">
                    ...
                    >
                        ...
                        >
                            <path
                                className={`${studentRender === "Class" ? "fill-secondary-1" : "fill-text-1"}`}
                                fill="#f5f5f5"
                        ...
                        {expand && (
                            <p
                                className={`font-medium text-[20px] text-start select-none ${
                                    studentRender === "Class" ? "text-secondary-1" : "text-text-1"
                                }`}
                            >
                                Classes
                            </p>
                    ...
                    >
                        ...
                        >
                            <path
                                className={`${studentRender === "Quiz" ? "fill-secondary-1" : "fill-text-1"}`}
                                fill="#f5f5f5"
                        ...
                        {expand && (
                            <p
                                className={`font-medium text-[20px] text-start select-none ${
                                    studentRender === "Quiz" ? "text-secondary-1" : "text-text-1"
                                }`}
                            >
                                Quizzes
                            </p>
